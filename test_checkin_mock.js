...
const saveUserResult = Storage.saveUserInfo(testUserInfo)
const savedUserInfo = Storage.getUserInfo()
console.log('✅ 用户信息保存:', saveUserResult.success ? '通过' : '失败')
console.log('✅ 用户信息获取:', savedUserInfo.nickName === testUserInfo.nickName ? '通过' : '失败')
...
console.log('✅ 数据更新:', updatedRecord && updatedRecord.diary === '更新后的学习日记内容' ? '通过' : '失败')
